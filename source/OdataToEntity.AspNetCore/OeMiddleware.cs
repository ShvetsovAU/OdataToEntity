...
namespace OdataToEntity.AspNetCore
{
    public class OeMiddleware
    {
        ...
        /// Метаданные, описанные в языке CSDL, используются Entity Framework для соотнесения сущностей и связей, определенных в концептуальной модели, к источнику данных (https://docs.microsoft.com/ru-ru/ef/ef6/modeling/designer/advanced/edmx/csdl-spec)
        /// </summary>
